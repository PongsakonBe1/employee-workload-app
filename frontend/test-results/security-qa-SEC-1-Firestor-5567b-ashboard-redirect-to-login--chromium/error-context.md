...
- Name: security-qa.spec.js >> SEC-1: Firestore Rules — Privilege Escalation >> unauthenticated user cannot access dashboard (redirect to login)
- Location: tests\security-qa.spec.js:16:3
...
Received string:  "http://localhost:3001/dashboard"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × unexpected value "http://localhost:3001/dashboard"
