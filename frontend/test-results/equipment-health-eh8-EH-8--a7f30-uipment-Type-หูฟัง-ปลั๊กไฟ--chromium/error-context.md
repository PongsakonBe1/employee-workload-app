...
- Name: equipment-health-eh8.spec.js >> EH-8 TEST-2~7: Dashboard Features (Admin) >> TEST-3: Filter by Equipment Type (หูฟัง/ปลั๊กไฟ)
- Location: tests\equipment-health-eh8.spec.js:92:3
