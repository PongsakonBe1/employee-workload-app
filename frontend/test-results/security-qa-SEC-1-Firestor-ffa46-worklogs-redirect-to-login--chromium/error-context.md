...
- Name: security-qa.spec.js >> SEC-1: Firestore Rules — Privilege Escalation >> unauthenticated user cannot access worklogs (redirect to login)
- Location: tests\security-qa.spec.js:28:3
