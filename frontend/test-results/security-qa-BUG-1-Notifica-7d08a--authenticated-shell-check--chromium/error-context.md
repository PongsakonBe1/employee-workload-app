...
- Name: security-qa.spec.js >> BUG-1: Notification Bell — Broadcast soft-delete isolation >> notification dropdown markup exists in AppShell (authenticated shell check)
- Location: tests\security-qa.spec.js:52:3
