...
- Name: push-notification-e2e.spec.js >> PUSH-5: Frontend UI — Broadcast Section (Superadmin) >> หน้า /admin/settings โหลดได้และ redirect unauthenticated → /login
- Location: tests\push-notification-e2e.spec.js:148:3
...
- generic [active] [ref=e1]:
  - button "v2.7.0" [ref=e2] [cursor=pointer]:
    - img [ref=e3]
    - generic [ref=e7]: v2.7.0
...
```ts
  50  | // ─── 2. Auth Guard — Broadcast Endpoint ──────────────────────────────────────
  51  | 
  52  | test.describe("PUSH-2: Auth Guard — Broadcast Endpoint", () => {
  53  |   test.skip(!IS_BACKEND_AVAILABLE, "ข้าม: ตั้ง RENDER_URL หรือ BACKEND_LOCAL=1 ก่อนรัน");
  54  | 
