...
- Name: equipment-health-eh8.spec.js >> EH-8 TEST-2~7: Dashboard Features (Admin) >> TEST-6: Charts render without crash
- Location: tests\equipment-health-eh8.spec.js:165:3
