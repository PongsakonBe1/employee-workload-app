...
- generic [active] [ref=e1]:
  ...
  - main [ref=e24]:
    - generic [ref=e25]:
      - generic [ref=e26]:
        - generic [ref=e27]:
          - img "labboy logo" [ref=e28]
          - generic [ref=e29]: Workload Recorder
        - heading "บันทึกงาน IT ได้ง่ายขึ้น" [level=1] [ref=e30]
        - paragraph [ref=e31]: ออกแบบมาสำหรับเจ้าหน้าที่เทคนิค ICIT บันทึกงานห้องคอมพิวเตอร์ แก้ไขปัญหา คุมสอบ DL และส่งออกรายงานปีงบประมาณ
        - generic [ref=e32]:
          - generic [ref=e33]: งานในหน้าที่หลัก
          - generic [ref=e34]: หัวข้อรอง
          - generic [ref=e35]: ส่งออก CSV
      - generic [ref=e36]:
        - img [ref=e38]
        - heading "เข้าสู่ระบบ" [level=2] [ref=e41]
        - paragraph [ref=e42]: ใช้ Google Account ของ ICIT เท่านั้น
        - button "เข้าสู่ระบบด้วย Google" [ref=e43] [cursor=pointer]:
          - img [ref=e44]
          - text: เข้าสู่ระบบด้วย Google
        - paragraph [ref=e49]: เฉพาะอีเมล @icit.kmutnb.ac.th เท่านั้น
```
