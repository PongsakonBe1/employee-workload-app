...
- Name: security-qa.spec.js >> SEC-1: Firestore Rules — Privilege Escalation >> login page is accessible and shows Google sign-in
- Location: tests\security-qa.spec.js:9:3
