...
- generic [active] [ref=e1]:
  ...
  - main [ref=e22]:
    - generic [ref=e23]:
      - generic [ref=e24]:
        - generic [ref=e25]:
          - img "labboy logo" [ref=e26]
          - generic [ref=e27]: Workload Recorder
        - heading "บันทึกงาน IT ได้ง่ายขึ้น" [level=1] [ref=e28]
        - paragraph [ref=e29]: ออกแบบมาสำหรับเจ้าหน้าที่เทคนิค ICIT บันทึกงานห้องคอมพิวเตอร์ แก้ไขปัญหา คุมสอบ DL และส่งออกรายงานปีงบประมาณ
        - generic [ref=e30]:
          - generic [ref=e31]: งานในหน้าที่หลัก
          - generic [ref=e32]: หัวข้อรอง
          - generic [ref=e33]: ส่งออก CSV
      - generic [ref=e34]:
        - img [ref=e36]
        - heading "เข้าสู่ระบบ" [level=2] [ref=e39]
        - paragraph [ref=e40]: ใช้ Google Account ของ ICIT เท่านั้น
        - button "เข้าสู่ระบบด้วย Google" [ref=e41] [cursor=pointer]:
          - img [ref=e42]
          - text: เข้าสู่ระบบด้วย Google
        - paragraph [ref=e47]: เฉพาะอีเมล @icit.kmutnb.ac.th เท่านั้น
```
